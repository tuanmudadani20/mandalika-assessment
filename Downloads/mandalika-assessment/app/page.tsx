...
const stats = [
  { value: '81', label: 'Menit Total (maks)' },
  { value: '26', label: 'Tetrad (Part 1)' },
  { value: '30', label: 'ML-SJT (Part 2)' },
  { value: '25', label: 'Feedback Opsional' },
          ...
          <aside className="space-y-6">
            ...
            <section className="surface-card p-6">
              ...
              <div className="mt-6 space-y-4">
                {[
                  ['Part 1', '26 Tetrad Most-Least', 'Wajib · waktu 26 menit'],
                  ['Part 2', '26 ML-SJT', 'Wajib · waktu 30 menit'],
                  ['Part 3', '5 Kritik, Saran, dan Ide', 'Opsional · waktu diset 25 menit (boleh kosong)'],

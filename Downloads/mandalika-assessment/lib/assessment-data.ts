...
export const profileFlagMeta: Record<ProfileFlagKey, ProfileFlagDefinition> = {
  ...
  character_collapse: {
    key: 'character_collapse',
    label: 'Character Collapse',
    alert: 'critical',
    description:
      'Integritas atau Ownership berada di level sangat kritis (< 25%). Skor tinggi di dimensi lain tidak dapat mengkompensasi ini.',
    placement:
      'Tidak direkomendasikan untuk posisi yang memerlukan kepercayaan atau akses sensitif sebelum ada perbaikan terverifikasi.',
  },
  character_foundation_absent: {
    key: 'character_foundation_absent',
    label: 'Character Foundation Absent',
    alert: 'critical',
    description:
      'Tiga atau lebih dimensi fondasi karakter berada di bawah threshold minimum.',
    placement:
      'Butuh coaching intensif dan reassessment 3–6 bulan sebelum penempatan atau promosi.',
  },
  c_player_critical: {
    key: 'c_player_critical',
    label: 'C Player Kritis',
    alert: 'critical',
    description:
      'Skor akhir < 30% atau ada override karakter yang memaksa kategori kritis. Membutuhkan intervensi segera.',
    placement:
      'Lakukan percakapan langsung, susun rencana perbaikan ketat, dan evaluasi kecocokan peran saat ini.',
  },
}
